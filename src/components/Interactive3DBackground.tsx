...
export default function Interactive3DBackground() {
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      // Fully clear the canvas coordinates every frame to prevent mobile GPU context corruption and pixel static/glitching
  ...
  return (
    <canvas
      ...
      className="fixed inset-0 w-full h-full pointer-events-none -z-10 bg-[#070708] opacity-55"
    />
  );
}
